    ...
    public static void main(String[] args) {
        ...
        while (!(command = scanner.nextLine()).equals("exit")) {
            ...
            if (command.equals("date")) {
                ...
                output = now.toLocalDate().toString(); // Get the unformatted date.
            } 
            else if (command.equals("time")) {
                LocalDateTime now = LocalDateTime.now();
                output = now.toLocalTime().toString(); // Get the unformatted time.
            }  
                ...
                if (varName.isEmpty()) {
                    output = "Missing arguments. Usage: printenv <variable_name>";
                } else {
                    String envValue = System.getenv(varName);
                    if (envValue != null) {
                        output = envValue;
                    } else {
                        output = "Environment variable '" + varName + "' not found.";
                    }
                }
            } 
